...
### [go-kit 系列文章归档地址](https://github.com/geelph/go-learning-single-step/tree/master/go-kit) (详细介绍)
...
### [hlb-grpc](https://github.com/geelph/go-learning-single-step/tree/master/hlb-grpc) (gRPC负载均衡（自定义负载均衡策略--etcd 实现)
...
### [AUTH2 代码地址](https://github.com/geelph/go-learning-single-step/tree/master/ddd-auth2-example)

# Golang DDD 的项目分层结构（六边形架构）

### [DDD](https://github.com/geelph/go-learning-single-step/tree/master/ddd-project-example) （DDD 项目分层结构）
...
### [hlog](https://github.com/geelph/go-learning-single-step/tree/master/hlog) (源码地址)
...
### [hconfig 插拔式配置读取工具可动态加载](https://github.com/geelph/go-learning-single-step/tree/master/hconfig)
...
### [go_push](https://github.com/geelph/go-learning-single-step/tree/master/go_push) (推送服务)
...
### [HConf (基于etcd与viper的高可用配置中心)](https://github.com/geelph/go-learning-single-step/tree/master/hconf)
...
### [timezonefinder](https://github.com/geelph/go-learning-single-step/tree/master/timezonefinder)

    1: 通过时区获取当前国家码和大洲码
    2: Country to Continent Mapping
    3: Timezone to Country Mapping

### [HEvent (基于channel )](https://github.com/geelph/go-learning-single-step/tree/master/hevent)

    1: 基于channel的简单事件订阅发布

### [设计模式](https://github.com/geelph/go-learning-single-step/tree/master/design-patterns)

    1: 并发设计模式之Active Object
    2: Go 实现的责任链模式

### [micro_agent](https://github.com/geelph/go-learning-single-step/tree/master/micro_agent) (micro微服务)
...
### [all_packaged_library](https://github.com/geelph/go-learning-single-step/tree/master/all_packaged_library) 里面封装了一些常用的库，有详细的介绍，持续更新
...
### [docker](https://github.com/geelph/go-learning-single-step/tree/master/docker) (为你的服务插上docker_compose翅膀)

     1: docker 为你的服务插上docker_compose翅膀

### [kafka](https://github.com/geelph/go-learning-single-step/tree/master/kafka) (分布式消息发布订阅系统)

    1: main 消息队列

### [NATS_streaming](https://github.com/geelph/go-learning-single-step/tree/master/NATS_streaming) (分布式消息发布订阅系统--是由NATS驱动的数据流系统)

    1: main 消息队列

### [nsq](https://github.com/geelph/go-learning-single-step/tree/master/nsq) (分布式实时消息平台)

    1: main 消息队列

### [grpc](https://github.com/geelph/go-learning-single-step/tree/master/grpc) (grpc学习)

    1: bidirectional_streaming_rpc 双向流grpc
    2: server_side_streaming_rpc 服务端流grpc，也可以写成客户端流grpc
    3: simple_rpc 简单grpc

### [rpc](https://github.com/geelph/go-learning-single-step/tree/master/rpc) (rpc学习)

    1: main rpc学习

### [prometheus](https://github.com/geelph/go-learning-single-step/tree/master/prometheus) (监控报警系统)

    1: server Prometheus监控报警系统

### [jaeger](https://github.com/geelph/go-learning-single-step/tree/master/jaeger) (jaeger分布式链路追踪)

    1: main jaeger分布式链路追踪

### [service_load_balancing](https://github.com/geelph/go-learning-single-step/tree/master/service_load_balancing) (负载均衡)

    1: fisher_yates_test  添加fisher-yates算法 负载均衡节点

### [hystrix](https://github.com/geelph/go-learning-single-step/tree/master/hystrix) (熔断)

    1: hystrix 学习并使用熔断（Hystrix）

### [req_limit](https://github.com/geelph/go-learning-single-step/tree/master/req_limit) (限流)

    1: main 使用带缓存的channel实现限流
    2: uber_ratelimit 使用uber_ratelimit实现限流

### [ini](https://github.com/geelph/go-learning-single-step/tree/master/ini) (配置文件库)

    1: main 配置文件ini的读取，以及自动匹配到结构体里面

### [minio](https://github.com/geelph/go-learning-single-step/tree/master/minio) (对象存储服务)

    1: minio 对象存储服务使用

### [mysql](https://github.com/geelph/go-learning-single-step/tree/master/mysql) (mysql服务器)

    1: main 简单的mysql使用

### [redis](https://github.com/geelph/go-learning-single-step/tree/master/redis) (redis相关)
...
### [mongodb](https://github.com/geelph/go-learning-single-step/tree/master/mongodb) (mongodb服务器)

    1: mgo.v2  mgo.v2库的基础使用学习
    2: mongo-go-driver  官方库的demo，以及事务提交（不能是单节点）

### [gin](https://github.com/geelph/go-learning-single-step/tree/master/gin) (web框架gin学习)

    1: mvc 模式，swagger文档 可作为基础学习gin

### [jwt](https://github.com/geelph/go-learning-single-step/tree/master/jwt) (JSON WEB TOKEN)

    1: jwt 学习使用

### [snow_flake](https://github.com/geelph/go-learning-single-step/tree/master/snow_flake) (雪花算法)

    1: main 雪花算法

### [encryption_algorithm](https://github.com/geelph/go-learning-single-step/tree/master/encryption_algorithm) (双棘轮算法, KDF链,迪菲-赫尔曼棘轮,x3dh)

    1: aes ase-(cfb,cbc,ecb)-(128,192,256)加解密方法
    2: curve25519 椭圆曲线算法
    3: 3curve25519 双棘轮算法,KDF链

### [LRU](https://github.com/geelph/go-learning-single-step/tree/master/LRU) (缓存淘汰算法)

    1: list lru 缓存淘汰算法

### [tcp](https://github.com/geelph/go-learning-single-step/tree/master/tcp) (tcp协议实现)

    1: 实现网络库，封包，解包 len+tag+data 模式

### [websocket](https://github.com/geelph/go-learning-single-step/tree/master/websocket) (websocket协议实现)

    1: 实现网络库

### [binary_conversion](https://github.com/geelph/go-learning-single-step/tree/master/tool/binary_conversion) (进制转换)
...
### [job_worker_mode](https://github.com/geelph/go-learning-single-step/tree/master/job_worker_mode) (job_worker模式)

    1: worker job_worker模式，可提高系统吞吐量

### [filewatch](https://github.com/geelph/go-learning-single-step/tree/master/filewatch) (监控文件变化)

    1: main 监控文件变化 可实现自动构建

### [prometheus](https://github.com/geelph/go-learning-single-step/tree/master/prometheus) (普罗米修斯)

    1: main 普罗米修斯

### [goquery](https://github.com/geelph/go-learning-single-step/tree/master/goquery) (网页解析工具)

    1: main 可以作为爬虫解析网页使用

### [active_object](https://github.com/geelph/go-learning-single-step/tree/master/active_object) (并发设计模式)

    1: active_object Go并发设计模式之Active Object

### [heap](https://github.com/geelph/go-learning-single-step/tree/master/container/heap) (优先级队列)

    1: heap 利用heap创建一个优先级队列

### [cli](https://github.com/geelph/go-learning-single-step/tree/master/cli) (go命令行交互)

    1: main go命令行交互

### [context](https://github.com/geelph/go-learning-single-step/tree/master/context) (context包学习)

    1: main context包学习

### [err](https://github.com/geelph/go-learning-single-step/tree/master/err) (error 相关)

    1: main golang 1.13 error 相关

### [interface](https://github.com/geelph/go-learning-single-step/tree/master/interface) (interface包学习)

    1: main interface包学习
    2: middleware Golang 基于interface 实现中间件

### [syncPool](https://github.com/geelph/go-learning-single-step/tree/master/syncPool) (syncPool包学习)

    1: main syncPool包学习

### [reflect](https://github.com/geelph/go-learning-single-step/tree/master/reflect) (reflect包学习)
